source "proxmox-iso" "compute-optimized" {
  ...
  iso_file     = "WD_MASS:iso/ubuntu-24.04.3-live-server-amd64.iso"
  node         = "pve"
  vm_id        = "10006"
  ssh_username = "ubuntu"
  ssh_password = "ubuntu"
  ...
  onboot               = true
  template_name        = "ubuntu-24.04.3-lts-server-compute-optimized"
  template_description = "Ubuntu 24.04.3 LTS Compute Optimized Server with 8C2T and 16GB RAM"
  unmount_iso          = true
